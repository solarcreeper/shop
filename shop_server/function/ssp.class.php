...
class SSP {
	 ...
	 *  @return array          Server-side processing response array
	 */
	static function simple_with_filter ( $request, $table, $primaryKey, $columns , $filter_value)
	{
		$bindings = array();
		// SQL server connection information
		$sql_details = array(
	 ...
	 *  @return array          Server-side processing response array
	 */
	static function search_index ( $request, $table, $primaryKey, $columns, $whereResult=null, $whereAll=null)
	{
		$bindings = array();
		$sql_details = array(
			'user' => user,
